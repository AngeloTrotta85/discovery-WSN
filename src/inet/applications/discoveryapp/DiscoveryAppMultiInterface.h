...
#ifndef INET_APPLICATIONS_DISCOVERYAPP_DISCOVERYAPPMULTIINTERFACE_H_
#define INET_APPLICATIONS_DISCOVERYAPP_DISCOVERYAPPMULTIINTERFACE_H_
...
class INET_API DiscoveryAppMultiInterface : public ClockUserModuleMixin<ApplicationBase>, public UdpSocket::ICallback
{
public:
    typedef struct {
        simtime_t timestamp;
...
public:
    DiscoveryAppMultiInterface() {};
    virtual ~DiscoveryAppMultiInterface();
};

} // namespace inet

#endif /* INET_APPLICATIONS_DISCOVERYAPP_DISCOVERYAPPMULTIINTERFACE_H_ */
